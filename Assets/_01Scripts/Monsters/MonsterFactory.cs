...
{//몬스터 재활용 스크립트
    ...
    List<MonsterRecycle> pool = new List<MonsterRecycle>();//몬스터 풀 리스트 저장
    MonsterRecycle monsterPrefab;//몬스터 프리팹
    ...
    public MonsterRecycle GetMonster()
    {
        ...
        MonsterRecycle obj = pool[lastIndex];//pool리스트 마지막 몬스터를 obj에 담음
